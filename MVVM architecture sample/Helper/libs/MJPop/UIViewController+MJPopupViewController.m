...
MJPopupViewAnimation _defaultAnimation = MJPopupViewAnimationFade;
CGFloat _defaultAlpha = 0.7f;
...
static void _RemovePopupControllerWithId (long pid) {
...
static NSArray *_PopupControllerWithId (long pid) {
...
- (void)presentPopupView:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType contentInteraction:(MJPopupViewContentInteraction)contentInteraction setAlpha:(CGFloat)alpha;
@end
...
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType contentInteraction:(MJPopupViewContentInteraction)contentInteraction {
    [self presentPopupViewController:popupViewController animationType:_defaultAnimation contentInteraction:contentInteraction setAlpha:_defaultAlpha];
}
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType contentInteraction:(MJPopupViewContentInteraction)contentInteraction setAlpha:(CGFloat)alpha
{
    ...
    [self presentPopupView:popupViewController animationType:animationType contentInteraction:contentInteraction setAlpha:alpha];
}
...
{
    long popupId = popupViewController.view.tag;
...
{ 
    ...
    switch (animationType) {
        ...
        case MJPopupViewAnimationSlideRightRight:
            ...
            break;
        default:
            [self fadeViewIn:popupViewController sourceView:sourceView overlayView:overlayView setAlpha:alpha];
            break;
    }
...
- (void)fadeViewIn:(UIViewController*)popupViewController sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView setAlpha:(CGFloat)alpha
{
    __weak UIViewController *backupedPopupViewController = popupViewController;
    long popupId = popupViewController.view.tag;
    NSArray *popupInfo = _PopupControllerWithId(popupId);
